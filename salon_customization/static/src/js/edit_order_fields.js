...
export class EditOrderLineProductField extends Many2OneField {
    ...
    async _openGridConfigurator(edit) {
        ...
        console.log("PurchaseOrderRecord_2", PurchaseOrderRecord_2)
        console.log("edit.......", this.props.record.data.product_ids[0])
...
EditOrderLineProductField.template = "add_product_line.EditProductField";

registry.category("fields").add("edit_product_many2one", EditOrderLineProductField);
